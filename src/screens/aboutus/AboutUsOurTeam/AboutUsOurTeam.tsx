...
export const AboutUsOurTeam = () => {
  return (
    <section className="relative w-full flex flex-col items-center" style={{ marginTop: '150px', marginBottom: '150px' }}>
      {/* Badge */}
      ...
      <div className="flex flex-row items-start justify-center" style={{ marginTop: '67px', gap: '30px' }}>
        
        {/* Member 1: Placeholder */}
        <div className="flex flex-col items-start">
          <div
            className="relative p-px rounded-[10px] overflow-hidden"
            style={{
              width: '326px',
              height: '420px',
          ...
          >
            <span className="[font-family:'M_PLUS_2',Helvetica]" style={{ color: '#FFF', fontSize: '20px', fontWeight: 400 }}>
              Team Member
            </span>
          </div>
          <span className="[font-family:'M_PLUS_2',Helvetica]" style={{ marginTop: '19px', color: '#FFF', fontSize: '16px', fontWeight: 400, marginLeft: '12px' }}>
            Position
          </span>
        </div>
