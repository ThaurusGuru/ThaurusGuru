...
export const SponsorSection = () => {
  ...
  return (
    <section className="relative w-full min-h-[250px] md:min-h-[892px] py-8 md:py-16 overflow-visible">
      ...
      <img
        className="absolute inset-0 top-[-140px] md:top-0 w-full h-[300%] md:h-full object-contain z-0 filter-[blur(12px)] md:filter-[blur(25px)]"
        style={{
      ...
      <img
        className="absolute top-0 md:top-[100px] left-0 w-[487.562px] h-[320px] md:w-full md:h-auto object-cover md:object-contain z-10"
        alt="PML Front"
        src="/sponsor/frontpml.png"
      />
      
      {/* Content container */}
      <div className="relative max-w-[1440px] mx-auto px-0 md:px-[140px] pt-1 md:pt-32 z-20 flex flex-col items-center md:items-start md:block">
        {/* Header with logo */}
        <div className="flex items-center gap-2 md:gap-4 mb-2 md:mb-8 translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms] -ml-24 md:ml-0 md:mt-0">
